...
def render_latex():
    ...
    with tempfile.TemporaryDirectory() as work_dir:
        ...
        #r.raise_for_status()
        return os.path.join(work_dir, 'out.png')
        #return jsonify(response_type = "in_channel" , attachments = [{"name": "out.png", "content_url": os.path.join(work_dir, 'out.png'), "content_type": "image/png"  }]  )
    return ""
