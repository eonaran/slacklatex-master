...
def render_latex():
    ...
    with tempfile.TemporaryDirectory() as work_dir:
        ...
        return jsonify(response_type = "in_channel" , attachments = [{"fallback": "tex", "text": os.path.join(work_dir, 'out.png'), "image_url": os.path.join('https://slacklatexeo.herokuapp.com',  os.path.join(work_dir, 'out.png'))  }]  )
    return ""
